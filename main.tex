...
\addcontentsline{toc}{chapter}{Περίληψη}
    ...
    \chapter{Εισαγωγή}
        ...
        \par
        Το γονίδιο PINK1 κωδικοποιεί μια κινάση με προστατευτική λειτουργία μιτοχονδρικής δυσλειτουργίας (\emph{\cite{Trevisan2024GeneticsPerspectives}}). Διαλληλικές παραλλαγές σχετίζονται με εκδήλωση της νόσου σε νεαρή ηλικία με σίγουρη εκδήλωση της νόσου και αντιπροσωπεύει το δεύτερο πιο συχνό αίτιο πρώιμης εκδήλωσης της νόσου λόγω αυτοσωμικά υπολειπόμενου γονιδίου μετά το PRKN.
        
        \par
        Για το γονίδιο VPS35 αναφέρεται πως μεταλλάξεις του μπορούν να επηρεάσουν την λειτουργία πρωτεϊνικής εκκαθάρισης και της ικανότητας της να ρυθμίζει τον σχηματισμό λυσοσωμάτων (\emph{\cite{Trevisan2024GeneticsPerspectives}}), δηλαδή τον μηχανισμό μεταβολισμού του κυττάρου και της αποδόμησης, υπεύθυνο για την ομοιόσταση των κυττάρων (\emph{\cite{Yang2021LysosomeFunctions}}). Ως συνέπεια μπορεί να θεωρηθεί η συσσώρευση πρωτεϊνών, που διαφορετικά θα ήταν υποψήφιες προς αποδόμηση, μεταξύ άλλων και η συνουκλεΐνη-α. 
        \par
        Με το γονίδιο GBA1 κωδικοποιείται ένα ένζυμο της λυσοσωμικής μεμβράνης που διαδραματίζει σημαντικό ρόλο στην ομοιόσταση σύνθετων λιπιδίων (\emph{\cite{Trevisan2024GeneticsPerspectives}}). Μεταλλάξεις στο γονίδιο GBA1 δύναται να οδηγήσουν σε λυσοσωμική δυσλειτουργία και πιθανώς στη συνέχεια να καταστεί ανεπαρκής ο μεταβολισμός της συνουκλεΐνης-α με συνέπεια τη συσσώρευση της εντός των κυττάρων. 
        
        
        \section{Νευροβιολογία}
        Η πηγή του φαινότυπου βρίσκεται σε κατεστραμμένους ντοπαμινεργικούς νευρώνες, στη μέλαινα ουσία του εγκεφάλου. Πρόκειται για μια περιοχή του εγκεφάλου, η οποία ανήκει δομικά στα βασικά γάγγλια. Η καταστροφή προξενείται λόγω της συσσώρευσης πρωτεΐνης, η οποία υπό μη παθολογικές συνθήκες θα είχε αποδομηθεί, ως αποτέλεσμα ενός υγιούς συστήματος κυτταρικού μεταβολισμού. Αντιθέτως, στη νόσο του Πάρκινσον ο μεταβολισμός αποτυγχάνει, συγκεκριμένα, όπως έχει αποδειχθεί, για την πρωτεΐνη της συνουκλεΐνης-α, η οποία συσσωρεύεται και συσσωματώνεται στους ντοπαμινεργικούς νευρώνες σε σωματίδια Lewy, καθιστώντας τα έτσι ανίκανα να παράξουν και να εκλύσουν τον νευροδιαβιβαστή ντοπαμίνη.
